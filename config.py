...
pretrained_model = {'resnet50' : './models/pretrained/resnet50-19c8e357.pth', 'se_resnet101' : './models/pretrained/se_resnet101-7e38fcc6.pth',
...
def load_data_transformers(resize_reso=512, crop_reso=448, swap_num=[7, 7]):
    ...
    data_transforms = {
        ...
        'common_aug': transforms.Compose([
            ...
            transf.ColorJitter(brightness=[0.6,1.4],contrast=[0.6,1.4],saturation=[0.6,1.4],hue=0.4),
